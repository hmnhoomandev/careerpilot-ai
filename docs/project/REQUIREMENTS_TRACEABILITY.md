...
| NFR-003/NFR-015/NFR-019/SEC-006/SEC-012 | ADR-0029 container and Zurich infrastructure boundary | Non-root multi-stage images, hardened Compose, digest-only Cloud Run, private Cloud SQL, regional Pub/Sub/Secret Manager/KMS and least-privilege identities | Deployment architecture tests, Compose config, deterministic SBOM/provenance generation | Verified statically; Docker build and Terraform native validation remain environment-limited; no apply authorized |
