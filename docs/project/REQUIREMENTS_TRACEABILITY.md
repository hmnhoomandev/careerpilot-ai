...
| FR-001–FR-020/NFR-017 | ADR-0026 coherent product presentation | Responsive dashboard for profile, evidence, job, citations, agent status, draft approval, interview, tracking, notification and audit concepts | Workspace interaction, landmark, keyboard, axe, responsive semantic and build tests | Phase 14 UI baseline verified for activated local APIs; labelled labs remain non-production |
| SEC-003/SEC-006/SEC-011 | Safe browser and A2UI boundary | Server-authoritative actions, closed component/action allowlist, text-only rendering, confirmations and safe errors | Unknown schema/action, HTML-shaped text, denial, offline and exact action tests | Verified for Phase 14 browser scope |
| NFR-002/NFR-010/NFR-011/NFR-014 | ADR-0027 telemetry and local metrics dashboard | Versioned content-free events, correlation, bounded collector, p50/p95/outcome/provider/cost aggregation and owner-only API/UI | Schema/redaction, percentile, tenant authorization, propagation and API tests | Phase 15 local baseline verified; production exporters/SLO evidence deferred |
| FR-016/SEC-015/SEC-016/SEC-018 | Rights, consent, recoverable deletion and tombstone restore | Core privacy/backup controls and privacy API | Privacy unit/API tests | Phase 16 local; physical purge/legal review open |
| SEC-006/SEC-009/SEC-012/SEC-017 | KMS/config boundary, SSRF, headers and identity rate limit | Key/security modules and API middleware | Privacy tests and local DAST | Phase 16; managed controls Phase 17 |
| SEC-008/SEC-010/SEC-019/SEC-020 | Upload hardening, red-team corpus and scanner policy | Scanner, corpus, CI and control matrix | Red-team/SAST/SCA/secret/license gates | Phase 16; container/IaC N/A until Phase 17 |
| NFR-003/NFR-012/NFR-013/MET-004/MET-015–017 | Explicit routing, budget and evaluation controls | Prompt/model registries, privacy/quality/latency/availability/cost decision table, no fallback, budget/quota/cache policies, versioned offline report | Decision matrix, budget/quota/cache/no-fallback and nine-metric threshold tests | Verified for fake/local CHF 0 scope; live quality/cost deferred |
| NFR-003/NFR-015/NFR-019/SEC-006/SEC-012 | ADR-0029 container and Zurich infrastructure boundary | Non-root multi-stage images, hardened Compose, digest-only Cloud Run, private Cloud SQL, regional Pub/Sub/Secret Manager/KMS and least-privilege identities | Deployment tests, healthy Compose profiles, Trivy and three OpenTofu plans | Verified locally in Phase 17; no apply authorized |
| NFR-003/NFR-012/NFR-015/NFR-019/SEC-006/SEC-012 | ADR-0030 optional GKE decision and trust boundaries | Kustomize namespace, identities, digest workloads, probes/resources, HPA/PDB, deny networks and migration Job | `test_gke_reference.py`, deterministic render and Trivy Kubernetes scan | Verified render-only in Phase 18; cluster/IAM/CNI/secret/runtime evidence requires approved staging |
